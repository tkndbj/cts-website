...
export default function MobileProjectDetails({
      ...
      <div className="fixed inset-0 z-50 bg-black flex flex-col md:hidden">
        ...
        <div className="relative z-10 p-4">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 px-3 py-2 text-white text-sm"
          >
        ...
        <div className="flex-1 relative flex items-center justify-center p-4">
          <div className="relative w-full h-full">
            <Image
              src={bgImage}
              alt={selectedUnit || project.title}
              fill
        ...
        {interiors && interiors.length > 0 && (
          <div className="relative z-10 bg-black/80 border-t border-white/20 p-3">
  ...
  return (
    <div className="fixed inset-0 z-45 bg-gray-900 md:hidden flex flex-col">
      {/* Background Image */}
      ...
      {/* Header */}
      <div className="relative z-10 flex-shrink-0 pt-14 p-4">
        ...
        {/* Stats and Fullscreen Button Row */}
        {selectedUnit && unitData?.stats && (
          <div className="grid grid-cols-4 gap-2">
            <div className="rounded-lg border border-white/20 bg-black/60 backdrop-blur-sm p-2 text-center">
            ...
            <button
              onClick={toggleFullscreen}
              className="rounded-lg border border-white/20 bg-black/60 backdrop-blur-sm p-2 flex items-center justify-center text-white"
            >
      ...
      {/* Main Content Area - Empty flex-1 to push bottom content down */}
      <div className="relative z-10 flex-1"></div>

      {/* Bottom Section - Attached to bottom */}
      <div className="relative z-10 flex-shrink-0 pb-20">
